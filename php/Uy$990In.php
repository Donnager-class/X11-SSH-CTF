...
<body>
    <nav class="navbar background">
        <ul class="nav-list">
            ...
            <li><a href="/Yh!115Nk.php">Submit Report</a></li>
            <li><a href="/Ye$148Qa.php">Blog</a></li>
        ...
        <div class="box-main">
            <div class="firstHalf">
                ...
                <p class="center"><a href="#Order" 
                    ...
                    Below are staff to contact if you have
                    any questions about your assignments this month.</a>
                </p>
    ...
    <section class="service">
        ...
        <div id="service">
            <div class="box">
                <img src=
"https://i.imgur.com/dLmJC6F.jpeg"
...
<p>Secretary-General of the United Nations</p>
            ...
            <div class="box">
                <img src=
"https://i.postimg.cc/V6qz8PQm/Drummer-Season-4.webp"
                    alt="picture not displayed">
                <br>
...
<p>Co-Founder of the Navoo</p>
  
                <br>
                  
<p>You can contact her: -</p>
  
                  
<p>carminadrummer@yahoo.com</p>
...
<p>You can say he is our local cowboy. </p>
</div>
  
  <!-- <div class="box">
      <img src=
"https://i.postimg.cc/0NCtRVWh/unnamed.jpg"
          alt="picture not displayed">
      <br>
